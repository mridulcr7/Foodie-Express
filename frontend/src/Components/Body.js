...
const Body = () => {
    ...
    const fetchData = async () => {
        const data = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=26.896551310069&lng=81.00563116371632&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
